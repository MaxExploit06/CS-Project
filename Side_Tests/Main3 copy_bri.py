...
root.iconbitmap("E:\\___Python Programs\\CS-Project\\EMS.ico")
...
def click():
    pygame.mixer.music.load("E:\\___Python Programs\\CS-Project\\click.mp3")
    pygame.mixer.music.play(loops=0)

#Images
admin1=Image.open("E:\\___Python Programs\\CS-Project\\admin.png")
player1=Image.open("E:\\___Python Programs\\CS-Project\\player.png")
...
see1=Image.open("E:\\___Python Programs\\CS-Project\\see.png")
hide1=Image.open("E:\\___Python Programs\\CS-Project\\hide.png")
...
search1=Image.open("E:\\___Python Programs\\CS-Project\\search.png")
resized_search = search1.resize((16, 16))
isearch=ImageTk.PhotoImage(resized_search)

send1=Image.open("E:\\___Python Programs\\CS-Project\\send.png")
...
def GIF1_dark():
    ...
    gif_path = "E:\\___Python Programs\\CS-Project\\loading.gif"
...
def GIF1_light():
    ...
    global bg_img
    # Load the animated GIF image
    gif_path = "E:\\___Python Programs\\CS-Project\\loading2.gif"
    gif = Image.open(gif_path)
    frames = [ImageTk.PhotoImage(frame) for frame in ImageSequence.Iterator(gif)]
    # Create a Canvas widget to display the GIF background
    canvas = tb.Canvas(LA1, width=800, height=600)
...
def themeswap():
    global t, gif_path
    pygame.mixer.music.load("E:\\___Python Programs\\CS-Project\\toggle.mp3")
    pygame.mixer.music.play(loops=0)
    if t==0:
...
logging.basicConfig(filename="E:\\___Python Programs\\CS-Project\\login_log.txt", level=logging.INFO, format='%(asctime)s - %(message)s')
...
def login(username, password):
    with open("E:\\___Python Programs\\CS-Project\\user_accounts.txt", 'r') as file:
        for line in file:

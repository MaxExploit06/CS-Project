...
def themeswap():
    ...
    if t==0:
        ...
        b6_1.config(style="primary.Outline.TButton")
        b6_2_1.config(style="primary.Outline.TButton")
        b6_2.config(style="primary.Outline.TButton")
        b6_2_2.config(style="primary.Outline.TButton")
...
b1=tb.Button(M1_1, text='Display upcoming matches',command=f1_swap,style="Outline.TButton")
b2=tb.Button(M1_1, text='Display team', command=f2_swap,style="Outline.TButton")
b3=tb.Button(M1_1, text='Display team score', command=f3_swap,style="Outline.TButton")
b4=tb.Button(M1_2, text='Add player', command=f4_swap,style="Outline.TButton")
b5=tb.Button(M1_2, text='Add upcoming match', command=f5_swap,style="Outline.TButton")
b6=tb.Button(M1_2, text='Edit team', command=f6_swap,style="Outline.TButton")
b7=tb.Button(M1_3, text='Search player', command=f7_swap,style="Outline.TButton")
b8=tb.Button(M1_3, text='Update player details', command=f8_swap,style="Outline.TButton")
b9=tb.Button(M1_3, text='Remove player', command=f9_swap,style="Outline.TButton")
swap_val= IntVar()
